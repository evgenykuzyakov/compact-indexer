-- This is a ClickHouse table. See project README for instructions.
CREATE TABLE repl_actions_tx on CLUSTER cluster1
(
...
CREATE TABLE actions_tx AS repl_actions_tx
    ENGINE = Distributed(cluster1, near, repl_actions_tx);

CREATE TABLE repl_events ON CLUSTER cluster1
(
    block_height UInt64 COMMENT 'Block height',
    block_hash String COMMENT 'Block hash',
    block_timestamp DateTime64(9, 'UTC') COMMENT 'Block timestamp in UTC',
...
CREATE TABLE events AS repl_events
